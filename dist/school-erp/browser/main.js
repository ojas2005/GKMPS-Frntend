...
var _c0 = ["dot"];
var _c1 = ["ring"];
var _CursorComponent = class _CursorComponent {
  constructor() {
  ...
  ngAfterViewInit() {
    ...
    this.zone.runOutsideAngular(() => {
      ...
      on("mousemove", (e) => {
        ...
        const interactive = !!target?.closest?.(_CursorComponent.INTERACTIVE);
...
_CursorComponent.INTERACTIVE = 'a, button, input, select, textarea, label, [role="button"], tr.cursor-pointer, summary';
_CursorComponent.\u0275fac = function CursorComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CursorComponent)();
};
_CursorComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CursorComponent, selectors: [["app-cursor"]], viewQuery: function CursorComponent_Query(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275viewQuery(_c0, 5);
    \u0275\u0275viewQuery(_c1, 5);
  }
  if (rf & 2) {
    let _t;
    \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.dotRef = _t.first);
    \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.ringRef = _t.first);
  }
}, decls: 4, vars: 0, consts: [["ring", ""], ["dot", ""], ["aria-hidden", "true", 1, "cursor-ring"], ["aria-hidden", "true", 1, "cursor-dot"]], template: function CursorComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElement(0, "div", 2, 0)(2, "div", 3, 1);
  }
}, styles: ['@charset "UTF-8";\n\n\n\n.cursor-dot[_ngcontent-%COMP%], \n.cursor-ring[_ngcontent-%COMP%] {\n  position: fixed;\n  top: 0;\n  left: 0;\n  pointer-events: none;\n  z-index: 99999;\n  opacity: 0;\n  will-change: transform;\n}\n.cursor-dot[_ngcontent-%COMP%] {\n  width: 7px;\n  height: 7px;\n  margin: -3.5px 0 0 -3.5px;\n  border-radius: 9999px;\n  background: #0ea5e9;\n  box-shadow: 0 0 8px 1px rgba(14, 165, 233, 0.8);\n  transition: opacity 0.25s ease;\n}\n.cursor-ring[_ngcontent-%COMP%] {\n  width: 42px;\n  height: 42px;\n  margin: -21px 0 0 -21px;\n  border-radius: 9999px;\n  border: 1.5px solid rgba(14, 165, 233, 0.55);\n  background:\n    radial-gradient(\n      circle,\n      rgba(14, 165, 233, 0.16) 0%,\n      rgba(14, 165, 233, 0.05) 55%,\n      transparent 72%);\n  box-shadow: 0 0 18px 2px rgba(14, 165, 233, 0.28), inset 0 0 12px rgba(14, 165, 233, 0.18);\n  transition: opacity 0.25s ease;\n}\n@media (pointer: coarse) {\n  .cursor-dot[_ngcontent-%COMP%], \n   .cursor-ring[_ngcontent-%COMP%] {\n    display: none;\n  }\n}\n/*# sourceMappingURL=cursor.component.css.map */'] });
var CursorComponent = _CursorComponent;
(() => {
  ...
  `, styles: ['@charset "UTF-8";\n\n/* angular:styles/component:scss;8b2caf33f4440a1f44597c9dbb5be1bd80c3c5077946dfa903cc6ef4714d6484;/Users/ojastiwari/Downloads/GKMPS-Frntend/src/app/shared/components/cursor/cursor.component.ts */\n.cursor-dot,\n.cursor-ring {\n  position: fixed;\n  top: 0;\n  left: 0;\n  pointer-events: none;\n  z-index: 99999;\n  opacity: 0;\n  will-change: transform;\n}\n.cursor-dot {\n  width: 7px;\n  height: 7px;\n  margin: -3.5px 0 0 -3.5px;\n  border-radius: 9999px;\n  background: #0ea5e9;\n  box-shadow: 0 0 8px 1px rgba(14, 165, 233, 0.8);\n  transition: opacity 0.25s ease;\n}\n.cursor-ring {\n  width: 42px;\n  height: 42px;\n  margin: -21px 0 0 -21px;\n  border-radius: 9999px;\n  border: 1.5px solid rgba(14, 165, 233, 0.55);\n  background:\n    radial-gradient(\n      circle,\n      rgba(14, 165, 233, 0.16) 0%,\n      rgba(14, 165, 233, 0.05) 55%,\n      transparent 72%);\n  box-shadow: 0 0 18px 2px rgba(14, 165, 233, 0.28), inset 0 0 12px rgba(14, 165, 233, 0.18);\n  transition: opacity 0.25s ease;\n}\n@media (pointer: coarse) {\n  .cursor-dot,\n  .cursor-ring {\n    display: none;\n  }\n}\n/*# sourceMappingURL=cursor.component.css.map */\n'] }]
  }], null, { dotRef: [{
    type: ViewChild,
    args: ["dot"]
  }], ringRef: [{
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CursorComponent, { className: "CursorComponent", filePath: "src/app/shared/components/cursor/cursor.component.ts", lineNumber: 61 });
})();
...
_AppComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], decls: 2, vars: 0, template: function AppComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "router-outlet")(1, "app-cursor");
  }
}, dependencies: [RouterOutlet, CursorComponent], encapsulation: 2 });
var AppComponent = _AppComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AppComponent, [{
    type: Component,
    args: [{ selector: "app-root", standalone: true, imports: [RouterOutlet, CursorComponent], template: `
...
// src/app/core/constants/nav.ts
var ALL = Object.values(RoleNames);
var STAFF = [RoleNames.SuperAdmin, RoleNames.Principal, RoleNames.Admin];
var SELF_SERVICE = [RoleNames.Student, RoleNames.Parent];
var NAV_ITEMS = [
...
function SidebarComponent_ng_container_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "a", 11)(2, "span", 12);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", item_r1.route)("routerLinkActiveOptions", \u0275\u0275pureFunction0(3, _c02));
    \u0275\u0275advance(2);
...
function SidebarComponent_div_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function SidebarComponent_div_15_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onClose.emit());
    });
    \u0275\u0275elementEnd();
  }
}
...
_SidebarComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], inputs: { isOpen: "isOpen" }, outputs: { onClose: "onClose" }, decls: 16, vars: 2, consts: [[1, "w-64", "bg-white", "border-r", "border-neutral-200", "flex", "flex-col", "h-screen", "shadow-sm"], [1, "p-6", "border-b", "border-neutral-200"], [1, "flex", "items-center", "gap-2"], [1, "w-10", "h-10", "bg-gradient-to-br", "from-primary-500", "to-primary-600", "rounded-xl", "flex", "items-center", "justify-center", "text-white", "font-bold", "text-lg"], [1, "font-bold", "text-lg", "text-neutral-900"], [1, "text-xs", "text-neutral-500"], [1, "flex-1", "overflow-y-auto", "px-3", "py-6", "space-y-1"], [4, "ngFor", "ngForOf"], [1, "p-4", "border-t", "border-neutral-200", "bg-neutral-50"], [1, "text-xs", "text-neutral-500", "text-center"], ["class", "fixed inset-0 bg-black/50 z-40", 3, "click", 4, "ngIf"], ["routerLinkActive", "bg-primary-50 text-primary-600", 1, "flex", "items-center", "gap-3", "px-4", "py-3", "rounded-lg", "text-neutral-700", "hover:bg-neutral-100", "transition-colors", "group", 3, "routerLink", "routerLinkActiveOptions"], [1, "text-sm", "font-medium"], [1, "fixed", "inset-0", "bg-black/50", "z-40", 3, "click"]], template: function SidebarComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(11, SidebarComponent_ng_container_11_Template, 4, 4, "ng-container", 7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 8)(13, "p", 9);
    \u0275\u0275text(14, "v1.0.0");
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(15, SidebarComponent_div_15_Template, 1, 0, "div", 10);
  }
  if (rf & 2) {
    \u0275\u0275advance(11);
...
}, dependencies: [CommonModule, NgForOf, NgIf, RouterLink, RouterLinkActive], encapsulation: 2 });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SidebarComponent, { className: "SidebarComponent", filePath: "src/app/shared/components/sidebar/sidebar.component.ts", lineNumber: 71 });
})();
...
function TopbarComponent_div_15_p_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 30);
    \u0275\u0275text(1, "Nothing new right now.");
    \u0275\u0275elementEnd();
  }
}
function TopbarComponent_div_15_div_4_span_4_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r1.className(a_r1.targetClassId));
  }
}
function TopbarComponent_div_15_div_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 31)(1, "div", 32)(2, "p", 18);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, TopbarComponent_div_15_div_4_span_4_Template, 2, 1, "span", 33);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", a_r1.targetClassId);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(a_r1.body);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(9, 4, a_r1.publishedAtUtc, "medium"));
  }
}
function TopbarComponent_div_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, TopbarComponent_div_15_p_3_Template, 2, 0, "p", 28)(4, TopbarComponent_div_15_div_4_Template, 10, 7, "div", 29);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx_r1.announcements().length === 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r1.announcements());
  }
}
function TopbarComponent__svg_svg_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
...
function TopbarComponent__svg_svg_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 3);
    \u0275\u0275element(1, "path", 38);
...
function TopbarComponent_div_30_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(3, "path", 42)(4, "path", 43);
    \u0275\u0275elementEnd();
    \u0275\u0275text(5, " Settings ");
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(6, "button", 44);
    \u0275\u0275listener("click", function TopbarComponent_div_30_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
...
var _TopbarComponent = class _TopbarComponent {
  constructor() {
    ...
    this.communication = inject(CommunicationService);
    this.isDark = this.themeService.isDark;
    this.showUserMenu = signal(false, ...ngDevMode ? [{ debugName: "showUserMenu" }] : []);
    this.showAnnouncements = signal(false, ...ngDevMode ? [{ debugName: "showAnnouncements" }] : []);
    this.announcements = signal([], ...ngDevMode ? [{ debugName: "announcements" }] : []);
    this.className = classNameById;
    this.userName = computed(() => this.auth.currentUser()?.fullName ?? "Guest", ...ngDevMode ? [{ debugName: "userName" }] : []);
    this.userRole = computed(() => this.auth.currentUser()?.role ?? "", ...ngDevMode ? [{ debugName: "userRole" }] : []);
  ...
  loadAnnouncements() {
    ...
    const classId = this.auth.isSelfService() ? this.auth.classId() ?? void 0 : void 0;
...
_TopbarComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TopbarComponent, selectors: [["app-topbar"]], outputs: { onToggleSidebar: "onToggleSidebar" }, decls: 31, vars: 8, consts: [[1, "h-16", "bg-white", "border-b", "border-neutral-200", "flex", "items-center", "justify-between", "px-6", "shadow-sm"], [1, "flex", "items-center", "gap-4"], ["aria-label", "Toggle Sidebar", 1, "p-2", "rounded-lg", "hover:bg-neutral-100", "text-neutral-600", "transition-colors", 3, "click"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-5", "h-5"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M4 6h16M4 12h16M4 18h16"], [1, "hidden", "md:flex", "items-center", "gap-2", "bg-neutral-100", "rounded-lg", "px-3", "py-2", "max-w-xs"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-4", "h-4", "text-neutral-500"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"], ["type", "text", "placeholder", "Search...", 1, "bg-transparent", "outline-none", "text-sm", "w-32", "placeholder-neutral-400"], [1, "relative"], [1, "p-2", "rounded-lg", "hover:bg-neutral-100", "text-neutral-600", "relative", "transition-colors", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"], ["class", "absolute top-1 right-1 w-2 h-2 bg-error-500 rounded-full", 4, "ngIf"], ["class", "absolute top-12 right-0 bg-white rounded-lg shadow-lg border border-neutral-200 w-80 max-h-96 overflow-y-auto py-2 z-50", 4, "ngIf"], ["aria-label", "Toggle Theme", 1, "p-2", "rounded-lg", "hover:bg-neutral-100", "text-neutral-600", "transition-colors", 3, "click"], ["class", "w-5 h-5", "fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 4, "ngIf"], [1, "flex", "items-center", "gap-3", "pl-4", "border-l", "border-neutral-200"], [1, "text-right", "hidden", "sm:block"], [1, "text-sm", "font-medium", "text-neutral-900"], [1, "text-xs", "text-neutral-500"], [1, "w-10", "h-10", "bg-gradient-to-br", "from-primary-400", "to-primary-600", "rounded-full", "flex", "items-center", "justify-center", "text-white", "font-semibold", "text-sm"], [1, "p-1", "rounded", "hover:bg-neutral-100", "transition-colors", 3, "click"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-4", "h-4", "text-neutral-600"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M19 14l-7 7m0 0l-7-7m7 7V3"], ["class", "absolute top-16 right-6 bg-white rounded-lg shadow-lg border border-neutral-200 w-48 py-2 z-50", 4, "ngIf"], [1, "absolute", "top-1", "right-1", "w-2", "h-2", "bg-error-500", "rounded-full"], [1, "absolute", "top-12", "right-0", "bg-white", "rounded-lg", "shadow-lg", "border", "border-neutral-200", "w-80", "max-h-96", "overflow-y-auto", "py-2", "z-50"], [1, "px-4", "py-1.5", "text-xs", "font-semibold", "text-neutral-500", "uppercase", "tracking-wide"], ["class", "px-4 py-3 text-sm text-neutral-500", 4, "ngIf"], ["class", "px-4 py-2.5 border-t border-neutral-100 first:border-t-0 hover:bg-neutral-50", 4, "ngFor", "ngForOf"], [1, "px-4", "py-3", "text-sm", "text-neutral-500"], [1, "px-4", "py-2.5", "border-t", "border-neutral-100", "first:border-t-0", "hover:bg-neutral-50"], [1, "flex", "items-center", "justify-between", "gap-2"], ["class", "text-xs text-primary-600 whitespace-nowrap", 4, "ngIf"], [1, "text-xs", "text-neutral-600", "mt-0.5", "line-clamp-2"], [1, "text-xs", "text-neutral-400", "mt-1"], [1, "text-xs", "text-primary-600", "whitespace-nowrap"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M12 3v1m0 16v1m9-9h-1m-16 0H1m15.364 1.636l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"], [1, "absolute", "top-16", "right-6", "bg-white", "rounded-lg", "shadow-lg", "border", "border-neutral-200", "w-48", "py-2", "z-50"], [1, "w-full", "px-4", "py-2", "text-left", "text-sm", "text-neutral-700", "hover:bg-neutral-50", "flex", "items-center", "gap-2"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-4", "h-4"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M15 12a3 3 0 11-6 0 3 3 0 016 0z"], [1, "w-full", "px-4", "py-2", "text-left", "text-sm", "text-neutral-700", "hover:bg-neutral-50", "flex", "items-center", "gap-2", 3, "click"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"]], template: function TopbarComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "button", 2);
    \u0275\u0275listener("click", function TopbarComponent_Template_button_click_2_listener() {
      return ctx.onToggleSidebar.emit();
    });
    \u0275\u0275namespaceSVG();
    ...
    \u0275\u0275element(8, "input", 8);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "div", 1)(10, "div", 9)(11, "button", 10);
    \u0275\u0275listener("click", function TopbarComponent_Template_button_click_11_listener() {
      return ctx.toggleAnnouncements();
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(12, "svg", 3);
    \u0275\u0275element(13, "path", 11);
    \u0275\u0275elementEnd();
    \u0275\u0275template(14, TopbarComponent_span_14_Template, 1, 0, "span", 12);
    \u0275\u0275elementEnd();
    \u0275\u0275template(15, TopbarComponent_div_15_Template, 5, 2, "div", 13);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(16, "button", 14);
    \u0275\u0275listener("click", function TopbarComponent_Template_button_click_16_listener() {
      return ctx.toggleTheme();
    });
    \u0275\u0275template(17, TopbarComponent__svg_svg_17_Template, 2, 0, "svg", 15)(18, TopbarComponent__svg_svg_18_Template, 2, 0, "svg", 15);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "div", 16)(20, "div", 17)(21, "p", 18);
    \u0275\u0275text(22);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function TopbarComponent_Template_button_click_27_listener() {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275template(30, TopbarComponent_div_30_Template, 10, 0, "div", 24);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    \u0275\u0275advance(14);
    \u0275\u0275property("ngIf", ctx.announcements().length > 0);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx.showAnnouncements());
    \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TopbarComponent, [{
    type: Component,
    args: [{ selector: "app-topbar", standalone: true, imports: [CommonModule], template: `
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TopbarComponent, { className: "TopbarComponent", filePath: "src/app/shared/components/topbar/topbar.component.ts", lineNumber: 132 });
})();
...
function LayoutComponent_app_sidebar_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-sidebar", 5);
    \u0275\u0275listener("onClose", function LayoutComponent_app_sidebar_1_Template_app_sidebar_onClose_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("isOpen", ctx_r1.sidebarOpen());
  }
}
...
_LayoutComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LayoutComponent, selectors: [["app-layout"]], decls: 6, vars: 1, consts: [[1, "flex", "h-screen", "bg-neutral-50"], [3, "isOpen", "onClose", 4, "ngIf"], [1, "flex-1", "flex", "flex-col", "overflow-hidden"], [3, "onToggleSidebar"], [1, "flex-1", "overflow-auto"], [3, "onClose", "isOpen"]], template: function LayoutComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0);
    \u0275\u0275template(1, LayoutComponent_app_sidebar_1_Template, 1, 1, "app-sidebar", 1);
    \u0275\u0275elementStart(2, "div", 2)(3, "app-topbar", 3);
    \u0275\u0275listener("onToggleSidebar", function LayoutComponent_Template_app_topbar_onToggleSidebar_3_listener() {
...
}, dependencies: [CommonModule, NgIf, RouterOutlet, SidebarComponent, TopbarComponent], encapsulation: 2 });
var LayoutComponent = _LayoutComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(LayoutComponent, [{
    type: Component,
    args: [{ selector: "app-layout", standalone: true, imports: [CommonModule, RouterOutlet, SidebarComponent, TopbarComponent], template: `
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LayoutComponent, { className: "LayoutComponent", filePath: "src/app/shared/components/layout/layout.component.ts", lineNumber: 34 });
})();
...
var roleGuard = (route) => {
  ...
  if (auth.isLoggedIn() && (roles.length === 0 || auth.hasRole(...roles)))
    return true;
...
var routes = [
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-SY6GYYTX.js").then((m) => m.AUTH_ROUTES)
  },
  ...
  // is additionally gated by role via roleGuard (data.roles from the nav catalog).
  {
    ...
    children: [
      {
        path: "dashboard",
        loadChildren: () => import("./chunk-TRK2QKR6.js").then((m) => m.DASHBOARD_ROUTES)
      },
      {
        path: "my-portal",
        canActivate: [roleGuard],
        data: { roles: rolesFor("/my-portal") },
        loadChildren: () => import("./chunk-J5LT3QWC.js").then((m) => m.MY_PORTAL_ROUTES)
      },
      {
        path: "students",
        canActivate: [roleGuard],
        data: { roles: rolesFor("/students") },
        loadChildren: () => import("./chunk-PGGVU5FJ.js").then((m) => m.STUDENTS_ROUTES)
      },
      {
        path: "teachers",
        canActivate: [roleGuard],
        data: { roles: rolesFor("/teachers") },
        loadChildren: () => import("./chunk-JM2HDEKA.js").then((m) => m.TEACHERS_ROUTES)
      },
      {
        path: "attendance",
        canActivate: [roleGuard],
        data: { roles: rolesFor("/attendance") },
        loadChildren: () => import("./chunk-S6YO2AZU.js").then((m) => m.ATTENDANCE_ROUTES)
      },
      {
        path: "academics",
        canActivate: [roleGuard],
        data: { roles: rolesFor("/academics") },
        loadChildren: () => import("./chunk-VPCFMCXY.js").then((m) => m.ACADEMICS_ROUTES)
      },
      {
        path: "examination",
        canActivate: [roleGuard],
        data: { roles: rolesFor("/examination") },
        loadChildren: () => import("./chunk-NEEWJGJT.js").then((m) => m.EXAMINATION_ROUTES)
      },
      {
        path: "fees",
        canActivate: [roleGuard],
        data: { roles: rolesFor("/fees") },
        loadChildren: () => import("./chunk-TVXY3OJF.js").then((m) => m.FEES_ROUTES)
      },
      {
        path: "communication",
        canActivate: [roleGuard],
        data: { roles: rolesFor("/communication") },
        loadChildren: () => import("./chunk-EBKQFASP.js").then((m) => m.COMMUNICATION_ROUTES)
      },
      {
        path: "library",
        canActivate: [roleGuard],
        data: { roles: rolesFor("/library") },
        loadChildren: () => import("./chunk-3FD6WBJW.js").then((m) => m.LIBRARY_ROUTES)
      },
      {
        path: "transport",
        canActivate: [roleGuard],
        data: { roles: rolesFor("/transport") },
        loadChildren: () => import("./chunk-HUBQGG7P.js").then((m) => m.TRANSPORT_ROUTES)
      },
      {
        path: "reports",
        canActivate: [roleGuard],
        data: { roles: rolesFor("/reports") },
        loadChildren: () => import("./chunk-7Y2BHL3K.js").then((m) => m.REPORTS_ROUTES)
      },
      {
        path: "settings",
        canActivate: [roleGuard],
        data: { roles: rolesFor("/settings") },
        loadChildren: () => import("./chunk-VKWHM456.js").then((m) => m.SETTINGS_ROUTES)
      },
      {
        path: "",
...
var refreshedToken$ = new BehaviorSubject(null);
var authInterceptor = (req, next) => {
  const auth = inject(AuthService);
  const router = inject(Router);
  const isAuthCall = req.url.includes("/api/auth/");
  const withToken = (token) => token ? req.clone({ setHeaders: { Authorization: `Bearer ${token}` } }) : req;
  return next(withToken(auth.getAccessToken())).pipe(catchError((error) => {
    if (error.status !== 401 || isAuthCall || !auth.getRefreshToken()) {
      return throwError(() => error);
    }
    if (isRefreshing) {
      return refreshedToken$.pipe(filter((t) => t !== null), take(1), switchMap((token) => next(withToken(token))));
    }
    isRefreshing = true;
    refreshedToken$.next(null);
    return auth.refresh().pipe(switchMap((newToken) => {
      isRefreshing = false;
